...
const BOT_SCREEN_NAME = 'LearnToMakeABot'
...
function isCheckedTweet(homeTimeLineTweet) {
  // ボット自身のツイートは無視する。
  if (homeTimeLineTweet.user.screen_name === BOT_SCREEN_NAME) {
    return true;
  }
...
const stream = twitter.stream('statuses/filter', { track: '@' + BOT_SCREEN_NAME })
  .on('data', (tweet) => {
